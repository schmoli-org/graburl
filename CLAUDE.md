...
| `docs/private/` | Private working docs (submodule — not publicly readable) |

## Docs and plans

| Path | What goes here | Visibility |
|---|---|---|
| `docs/superpowers/specs/` | Finalized design specs — committed, public record | Public |
| `docs/private/` | Working plans, draft specs, ADRs, scratch notes | Private submodule |
| `.claude/plans/` | Claude Code session plans | Gitignored, ephemeral |

**Rule:** Never commit draft plans or working documents to `docs/superpowers/specs/` or anywhere else in the public tree. Working docs belong in `docs/private/`. A document graduates to `docs/superpowers/specs/` only when it describes a finalized decision worth preserving publicly.
